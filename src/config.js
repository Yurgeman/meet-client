...
export const SENTRY_DSN =
  ...
  "https://aa3d6993437b4663928da67c6e99c2e5@o573729.ingest.sentry.io/6382533";

export const ROOM_URL =
  process.env.VUE_APP_ROOM_URL || "https://conf.docsme.ru/ng/";
export const ROOM_PATH = process.env.VUE_APP_ROOM_PATH || "/ng/";

export const SHOW_FULLSCREEN = isTrue(
  process.env.VUE_APP_SHOW_FULLSCREEN,
  false
);
export const SHOW_INVITATION = isTrue(
  process.env.VUE_APP_SHOW_INVITATION,
  false
);
