<template>
  <div class="text">
    ...
    <div class="form-group settings-group"
         v-if="false">
      <sea-switch v-model="state.bandwidth">{{ l.settings.bandwidth }}
      </sea-switch>
    ...
    <div class="form-group settings-group"
      ...
      <!--</label>-->
      <div v-if="state.backgroundMode === 'image'"
           class="settings-info">
        {{ l.settings.image_tip }}
        <div v-if="!state.backgroundAuthor">
          <img v-if="state.backgroundImageURL"
        ...
        <div v-else>
          ...
          on
          <a href="https://unsplash.com/?utm_source=briefing&utm_medium=referral"
             target="_blank"
             rel="noopener nofollow">Unsplash</a>.
          <br/>
          <br/>
          <a href="#"
             @click.prevent="doUnSplashImage">{{ l.settings.random_image }}</a>
        </div>
      </div>
    </div>
    <!--<div class="release-info">-->
    <!--<a href="#"-->
    <!--   @click.prevent="showInfo = !showInfo">Server Info</a>-->
    <!--|-->
    <!--<a href="https://github.com/holtwick/briefing"-->
    <!--   target="_blank"-->
    <!--   rel="noopener"-->
    <!--   title="Open Github source code repository">{{ release }}</a>-->
    <!--</div>-->
    <div v-if="showInfo">
      <div class="form-group settings-group">
        ...
        <div>
          <a href="#"
             @click.prevent="doCheckSignal">Check Connectivity</a>
        </div>
      </div>
      <div class="form-group settings-group">
